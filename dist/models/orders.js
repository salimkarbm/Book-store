...
var orderStore = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        values = [order.status, order.userId];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        console.log(err_2);
                        throw new Error("unable to fetch orders from database ".concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("could not find order with id ".concat(id, ". Error: ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    orderStore.prototype.addProduct = function (quantity, orderId, productId) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, addProduct, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 2:
                        result = _a.sent();
                        addProduct = result.rows[0];
                        conn.release();
                        return [2 /*return*/, addProduct];
                    case 3:
                        err_4 = _a.sent();
                        console.error(err_4);
                        throw new Error("unable to add product with  id ".concat(productId, " ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
